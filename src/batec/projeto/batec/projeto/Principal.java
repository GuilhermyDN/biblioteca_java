...
public class Principal extends javax.swing.JFrame {
    ...
    private int selecionarLivro() {
        ...
        if (escolha == JOptionPane.OK_OPTION) {
            ...
            if (indiceSelecionado != -1) {
                ...
                JOptionPane.showMessageDialog(null, "Por favor, selecione um livro v�lido.", "Erro", JOptionPane.ERROR_MESSAGE);
            }
        }
        return 0;
    }
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Autor: Itamar Vieira J�nior");
        ...
        jMenuItem1.setText("Relat�rio de Acervo");
        ...
        jMenuItem4.setText("Registro de Movimenta��o");
        ...
        jMenuItem2.setText("Controle Bibliotec�rio");
        ...
        menuRelatorio.setText("Gerar relat�rio");
    ...
    JOptionPane.showMessageDialog(this, relatorioLivros.toString(), "Relat�rio de Livros", JOptionPane.INFORMATION_MESSAGE);
    ...
    botaoDeletar.addActionListener(new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (livroSelecionado != null) {
                int confirmacao = JOptionPane.showConfirmDialog(null, "Voc� deseja realmente deletar o livro:\n" +
                    "Nome: " + livroSelecionado.getNome() +
                    "\nAutor: " + livroSelecionado.getAutor() +
                    "\nEditora: " + livroSelecionado.getEditora() +
                    "\nISBN: " + livroSelecionado.getIsbn(), "Confirmar Dele��o", JOptionPane.YES_NO_OPTION);
            if (confirmacao == JOptionPane.YES_OPTION) {
                cadastro.removerLivro(indiceSelecionado);
                atualizarListaLivros();
            }
        } else {
            JOptionPane.showMessageDialog(null, "O �ndice selecionado n�o corresponde a um livro v�lido.", "Erro", JOptionPane.ERROR_MESSAGE);
        }
    } else {
    ...
    JOptionPane.showMessageDialog(null, jPanelBotoes, "Op��es", JOptionPane.PLAIN_MESSAGE);
